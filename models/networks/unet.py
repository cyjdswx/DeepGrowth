...
def number_of_features_per_level_with_max(init_channel_number, num_levels):
    return [min(init_channel_number * 2 ** k, 128) for k in range(num_levels)]
...
class DecoderNeo(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, scale_factor=(2, 2, 2), basic_module=DoubleConv,
        ...
        super(DecoderNeo, self).__init__()
